...
$ret=mysqli_query($con,"SELECT count(ID) id1 from vehicle_info where Status='' and eid='$eid'");
		 $row5=mysqli_fetch_array($ret);
		 
		 $ret=mysqli_query($con,"SELECT count(ID) id2 from vehicle_info where Status='Out' and eid='$eid'");
		  $row6=mysqli_fetch_array($ret);

		  $ret=mysqli_query($con,"SELECT count(ID) as id1 from vehicle_info where VehicleCategory='Two Wheeler' and eid='$eid'");
		$row=mysqli_fetch_array($ret);  
             
		$ret=mysqli_query($con,"SELECT count(ID) as id2 from vehicle_info where VehicleCategory='Four Wheeler' and eid='$eid'");
		$row2=mysqli_fetch_array($ret); 	
}
